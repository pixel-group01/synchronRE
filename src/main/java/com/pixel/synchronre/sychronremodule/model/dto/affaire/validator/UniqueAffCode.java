...
@Constraint(validatedBy = {UniqueAffCode.UniqueStaCodeValidatorOnCreate.class, UniqueAffCode.UniqueStaCodeValidatorOnUpdate.class})
@Documented
public @interface UniqueAffCode
{
    ...
    class UniqueStaCodeValidatorOnCreate implements ConstraintValidator<UniqueAffCode, String>
    {
    ...
    @Component
    @RequiredArgsConstructor
    class UniqueStaCodeValidatorOnUpdate implements ConstraintValidator<UniqueAffCode, UpdateAffairetReq>
    {
        private final StatutRepository statRepo;
        @Override
