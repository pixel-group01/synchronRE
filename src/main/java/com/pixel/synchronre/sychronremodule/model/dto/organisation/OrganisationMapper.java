...
public abstract class OrganisationMapper
{
    ...
    @Autowired protected AssociationRepository assoRepo;
    ...
    @Mapping(target = "paysList", expression = "java(assoRepo.getPaysByOrgCodes(java.util.Collections.singletonList(dto.getOrganisationCode())) )")
