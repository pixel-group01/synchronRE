...
public abstract class TraiteNPMapper
{
    ...
    @Mapping(target = "traiEcerciceRattachement", expression = "java(org.apache.commons.lang3.EnumUtils.getEnum(com.pixel.synchronre.sychronremodule.model.entities.EXERCICE_RATTACHEMENT.class, dto.getTraiEcerciceRattachement()))")
