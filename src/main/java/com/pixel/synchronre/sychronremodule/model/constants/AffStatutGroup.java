...
public class AffStatutGroup
{
    ...
    public static final List<String> tabEnCoursPaiement = Arrays.asList(EN_ATTENTE_DE_PAIEMENT.staCode, EN_COURS_DE_PAIEMENT.staCode,SOLDE.staCode, MAIL.staCode);
    ...
    public static final List<String> tabSaisieSous = Arrays.asList(SAISIE_CRT.staCode, TRANSMIS.staCode, EN_COURS_DE_REPARTITION.staCode, RETOURNE.staCode);
