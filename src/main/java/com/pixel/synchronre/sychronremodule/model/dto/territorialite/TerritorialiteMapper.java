...
public abstract class TerritorialiteMapper
{
    ...
    public abstract TerritorialiteResp mapToTerritorialiteResp(CreateTerritorialiteReq dto, TraiteNonProportionnel traite);
    ...
    public abstract Territorialite mapToTerritorialite(CreateTerritorialiteReq dto);
}
