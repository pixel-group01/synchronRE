...
public interface CategorieRepository extends JpaRepository<Categorie, Long>
{
    ...
    cat.categorieId, cat.categorieLibelle, cat.categorieCapacite, tnp.traiId,
...
""")
    Page<CategorieResp> search(@Param("traiId") Long traiId,  @Param("key")String key, Pageable pageable);
}