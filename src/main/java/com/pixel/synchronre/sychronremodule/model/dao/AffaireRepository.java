...
public interface AffaireRepository extends JpaRepository<Affaire, Long>
{
    ...
    @Query("""
        ...
        f.facSmpLci, f.facPrime, f.affStatutCreation, d.devCode, ced.cedId, s.staCode, s.staLibelle, c.couLibelle, ced.cedNomFiliale, ced.cedSigleFiliale, f.exercice.exeCode) 
