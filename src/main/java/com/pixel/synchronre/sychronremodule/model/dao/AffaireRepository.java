...
public interface AffaireRepository extends JpaRepository<Affaire, Long>
{
    ...
    @Query("""
        ...
        f.facSmpLci, f.facPrime, f.affStatutCreation, d.devCode, ced.cedId, concat(s.staCode, '(', f.affStatutCreation, ')'), s.staLibelle, c.couId, c.couLibelle, c.branche.branId, c.branche.branLibelle, ced.cedNomFiliale, ced.cedSigleFiliale, f.exercice.exeCode) 
