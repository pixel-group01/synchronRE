...
public interface ReglementRepository extends JpaRepository<Reglement, Long> {
    ...
    @Query("""
        ...
        from Reglement r left join r.affaire a left join r.sinistre s where (locate(upper(coalesce(?1, '') ), upper(cast(function('strip_accents',  coalesce(r.regReference, '') ) as string)) ) >0 
