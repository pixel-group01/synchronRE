package com.pixel.synchronre.authmodule.model.constants;
...
public class SecurityConstants
{
    ...
    public static final long ACCESS_TOKEN_DURATION = 1000l * 60l * 60l * 24l; // 24 heures
    public static final long REFRESH_TOKEN_DURATION = 1000l * 60l * 60l * 24l * 30l; // 30 jours
