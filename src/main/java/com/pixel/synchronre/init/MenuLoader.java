...
public class MenuLoader implements Loader
{
    ...
    public void load()
    {
        ...
        Menu menuSin = menuRepo.save(new Menu(null, "SIN", "Sinistres", "GET-SIN-SAI-LST::GET-SIN-TRANS-LST::GET-SIN-AVAL-LST::GET-SIN-SOLD-LST::GET-SIN-SUIV-LST::GET-SIN-ARCH-LST::VAL-SIN::RET-SIN::UPD-SIN::CRT-SIN::GET-SIN-REG-LST::GET-SIN-HISTO::GET-SIN-DET", PersStatus.ACTIVE));
        Menu menuCompta = menuRepo.save(new Menu(null, "COMPTA", "Comptabilité", "GET-STAT-SIN::GET-REG-FAC-LST::GET-REG-SIN-LST::GET-PAI-FAC-LST::GET-REV-FAC-LST::GET-PAI-SIN-LST::GET-REV-SIN-LST::GET-REG-SIN-LST::GET-SIN-SUIV-LST-COMPTA::GET-SIN-ARCH-LST-COMPTA::GET-SIN-SOLD-LST-COMPTA::CRT-PAI-SIN::CRT-REV-SIN::UPD-REV-SIN::GET-ETA-COMPT-SIN", PersStatus.ACTIVE));
