...
public class MenuLoader implements Loader
{
    ...
    public void load()
    {
        ...
        Menu menuProd = menuRepo.save(new Menu(null, "PROD", "Productions", "GET-FAC-LST::GET-FAC-C-SAI::GET-FAC-C-PLA::GET-FAC-C-REG::GET-FAC-ARCH::GET-FAC-HIST", PersStatus.ACTIVE));
        Menu menuSin = menuRepo.save(new Menu(null, "SIN", "Sinistres", "GET-SIN-LST", PersStatus.ACTIVE));
        Menu menuCompta = menuRepo.save(new Menu(null, "COMPTA", "Comptabilité", "GET-PAI-FAC-LST::GET-REV-FAC-LST::GET-PAI-SIN-LST::GET-REV-SIN-LST", PersStatus.ACTIVE));
        ...
        Menu menuAdmin = menuRepo.save(new Menu(null, "ADMIN", "Administration", "GET-USER-LST::GET-PRV-LST::GET-ROL-LST", PersStatus.ACTIVE));
    }
}
