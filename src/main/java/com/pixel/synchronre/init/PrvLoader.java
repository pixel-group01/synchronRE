...
public class PrvLoader implements Loader
{
    ...
    public void load()
    {
        ...
        AppPrivilege retFac = prvRepo.save(new AppPrivilege(null, "RET-FAC-CED", "Retourner une affaire facultative à la cédante", typeRepo.findByUniqueCode("PRV-FAC").orElseThrow(()->new AppException("Type de document inconnu"))));
        ...
        AppPrivilege crtRepFac = prvRepo.save(new AppPrivilege(null, "CRT-REP-FAC", "Enregistrer une repartition sur une affaires facultative", typeRepo.findByUniqueCode("PRV-FAC").orElseThrow(()->new AppException("Type de document inconnu"))));
        AppPrivilege transFacSous = prvRepo.save(new AppPrivilege(null, "TRANS-FAC-SOUS", "Transmettre une affaire facultative au souscripteur", typeRepo.findByUniqueCode("PRV-FAC").orElseThrow(()->new AppException("Type de document inconnu"))));
        AppPrivilege transFacVal = prvRepo.save(new AppPrivilege(null, "TRANS-FAC-VAL", "Transmettre une affaire facultative au validateur", typeRepo.findByUniqueCode("PRV-FAC").orElseThrow(()->new AppException("Type de document inconnu"))));
        AppPrivilege retFacSous = prvRepo.save(new AppPrivilege(null, "RET-FAC-SOUS", "Retourner une affaire facultative au souscripteur", typeRepo.findByUniqueCode("PRV-FAC").orElseThrow(()->new AppException("Type de document inconnu"))));
        AppPrivilege retFacVal = prvRepo.save(new AppPrivilege(null, "RET-FAC-VAL", "Retourner une affaire facultative au validateur", typeRepo.findByUniqueCode("PRV-FAC").orElseThrow(()->new AppException("Type de document inconnu"))));
        AppPrivilege getFacHisto = prvRepo.save(new AppPrivilege(null, "GET-FAC-HISTO", "Consulter l'historique d'une affaire facultative", typeRepo.findByUniqueCode("PRV-FAC").orElseThrow(()->new AppException("Type de document inconnu"))));
        AppPrivilege getFacmsgCompta = prvRepo.save(new AppPrivilege(null, "GET-FAC-MSG-COMPTA", "Consulter le message de retour du comptable sur une affaire facultative", typeRepo.findByUniqueCode("PRV-FAC").orElseThrow(()->new AppException("Type de document inconnu"))));
        AppPrivilege getFacmsgVal = prvRepo.save(new AppPrivilege(null, "GET-FAC-MSG-VAL", "Consulter le message de retour du validateur sur une affaire fac", typeRepo.findByUniqueCode("PRV-FAC").orElseThrow(()->new AppException("Type de document inconnu"))));
        AppPrivilege getFacmsgSous = prvRepo.save(new AppPrivilege(null, "GET-FAC-MSG-SOUS", "Consulter le message de retour du souscripteur sur une affaire facultative", typeRepo.findByUniqueCode("PRV-FAC").orElseThrow(()->new AppException("Type de document inconnu"))));
        //TRAI
        ...
        AppPrivilege getSinRegleLst = prvRepo.save(new AppPrivilege(null, "GET-SIN-REG-LST", "Consulter la liste des sinistres en attente en reglement", typeRepo.findByUniqueCode("PRV-SIN").orElseThrow(()->new AppException("Type de document inconnu"))));
        AppPrivilege getSinHisto = prvRepo.save(new AppPrivilege(null, "GET-SIN-HISTO", "Consulter l'historique d'un sinistre", typeRepo.findByUniqueCode("PRV-SIN").orElseThrow(()->new AppException("Type de document inconnu"))));
        AppPrivilege getSinDetails = prvRepo.save(new AppPrivilege(null, "GET-SIN-DET", "Consulter les details d'un sinistre", typeRepo.findByUniqueCode("PRV-SIN").orElseThrow(()->new AppException("Type de document inconnu"))));
        AppPrivilege getSinSoldLst = prvRepo.save(new AppPrivilege(null, "GET-SIN-SOLD-LST", "Consulter la liste des sinistres soldés", typeRepo.findByUniqueCode("PRV-SIN").orElseThrow(()->new AppException("Type de document inconnu"))));
        ...
        AppPrivilege getSinSoldLstCompta = prvRepo.save(new AppPrivilege(null, "GET-SIN-SOLD-LST-COMPTA", "Consulter la liste des sinistres soldés par le comptable", typeRepo.findByUniqueCode("PRV-SIN").orElseThrow(()->new AppException("Type de document inconnu"))));
        AppPrivilege getSinSuiviLstCompta = prvRepo.save(new AppPrivilege(null, "GET-SIN-SUIV-LST-COMPTA", "Suivi des sinistres par le comptable", typeRepo.findByUniqueCode("PRV-SIN").orElseThrow(()->new AppException("Type de document inconnu"))));
        AppPrivilege getSinArchLstCompta = prvRepo.save(new AppPrivilege(null, "GET-SIN-ARCH-LST-COMPTA", "Consulter la liste des sinistres archivés par le comptable", typeRepo.findByUniqueCode("PRV-SIN").orElseThrow(()->new AppException("Type de document inconnu"))));
        ...
        AppPrivilege msgSinCompta = prvRepo.save(new AppPrivilege(null, "GET-SIN-MSG-COMPTA", "Consulter le message de retour du comptable", typeRepo.findByUniqueCode("PRV-SIN").orElseThrow(()->new AppException("Type de document inconnu"))));
        AppPrivilege msgSinVal = prvRepo.save(new AppPrivilege(null, "GET-SIN-MSG-VAL", "Consulter le message de retour du validateur", typeRepo.findByUniqueCode("PRV-SIN").orElseThrow(()->new AppException("Type de document inconnu"))));
