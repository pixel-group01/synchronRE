...
public class PrvLoader implements Loader
{
    ...
    public void load()
    {
        AppPrivilege getUserDet = prvRepo.save(new AppPrivilege(null, "GET-USER-DET", "Consulter les informations sur un utilisateurs", typeRepo.findByUniqueCode("PRV-PRV-USER")));
        AppPrivilege crtUserFnc = prvRepo.save(new AppPrivilege(null, "CRT-USER-FNC", "Créer un utilisateur", typeRepo.findByUniqueCode("PRV-PRV-USER")));
        AppPrivilege getUserLst = prvRepo.save(new AppPrivilege(null, "GET-USER-LST", "Voir la liste des utilisateurs", typeRepo.findByUniqueCode("PRV-PRV-USER")));
        AppPrivilege updUser = prvRepo.save(new AppPrivilege(null, "UPD-USER", "Modifier un utilisateur", typeRepo.findByUniqueCode("PRV-PRV-USER")));
        AppPrivilege blqUser = prvRepo.save(new AppPrivilege(null, "BLQ-USER", "Bloquer un utilisateur", typeRepo.findByUniqueCode("PRV-PRV-USER")));
        AppPrivilege ublqUser = prvRepo.save(new AppPrivilege(null, "UBLQ-USER", "Débloquer un utilisateur", typeRepo.findByUniqueCode("PRV-PRV-USER")));
        AppPrivilege sendActMail = prvRepo.save(new AppPrivilege(null, "SEND-ACT-MAIL", "Envoyer un mail d'activation de compte", typeRepo.findByUniqueCode("PRV-PRV-USER")));
        AppPrivilege crtFnc = prvRepo.save(new AppPrivilege(null, "CRT-FNC", "Créer une fonction", typeRepo.findByUniqueCode("PRV-PRV-FONC")));
        AppPrivilege updFnc = prvRepo.save(new AppPrivilege(null, "UPD-FNC", "Modifier une fonction", typeRepo.findByUniqueCode("PRV-PRV-FONC")));
        AppPrivilege setFncDflt = prvRepo.save(new AppPrivilege(null, "SET-FNC-DFLT", "Définir une fonction comme fonction courante", typeRepo.findByUniqueCode("PRV-PRV-FONC")));
        AppPrivilege rvkFnc = prvRepo.save(new AppPrivilege(null, "RVK-FNC", "Revoquer une fonction", typeRepo.findByUniqueCode("PRV-PRV-FONC")));
        AppPrivilege rstrFnc = prvRepo.save(new AppPrivilege(null, "RSTR-FNC", "Restaurer une fonction", typeRepo.findByUniqueCode("PRV-PRV-FONC")));
        AppPrivilege getActFncLst = prvRepo.save(new AppPrivilege(null, "GET-ACT-FNC-LST", "Consulter la liste des fonctions actives d'un utilisateur", typeRepo.findByUniqueCode("PRV-PRV-FONC")));
        AppPrivilege getAllFncLst = prvRepo.save(new AppPrivilege(null, "GET-ALL-FNC-LST", "Consulter la liste de toutes les fonctions actives d'un utilisateur", typeRepo.findByUniqueCode("PRV-PRV-FONC")));
        AppPrivilege crtPrv = prvRepo.save(new AppPrivilege(null, "CRT-PRV", "Créer un privilège", typeRepo.findByUniqueCode("PRV-PRV-PRV")));
        AppPrivilege getPrvLst = prvRepo.save(new AppPrivilege(null, "GET-PRV-LST", "Consulter la liste des privilèges", typeRepo.findByUniqueCode("PRV-PRV-PRV")));
        AppPrivilege crtRol = prvRepo.save(new AppPrivilege(null, "CRT-ROL", "Créer un rôle", typeRepo.findByUniqueCode("PRV-PRV-ROL")));
        AppPrivilege getRolLst = prvRepo.save(new AppPrivilege(null, "GET-ROL-LST", "Consulter la liste des rôles", typeRepo.findByUniqueCode("PRV-PRV-ROL")));
        AppPrivilege getFacLst = prvRepo.save(new AppPrivilege(null, "GET-FAC-LST", "Consulter liste des affaires facultative", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege getFacCSai = prvRepo.save(new AppPrivilege(null, "GET-FAC-C-SAI", "Consulter liste des fac en cours de saisie", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege getFacCPla = prvRepo.save(new AppPrivilege(null, "GET-FAC-C-PLA", "Consulter liste des fac en cours de placement", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege getFacCReg = prvRepo.save(new AppPrivilege(null, "GET-FAC-C-REG", "Consulter liste des fac en cours de règlement", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege getFacArch = prvRepo.save(new AppPrivilege(null, "GET-FAC-ARCH", "Consulter liste des fac archivées", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege getFacHist = prvRepo.save(new AppPrivilege(null, "GET-FAC-HIST", "Consulter l'historique des facs", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege crtFac = prvRepo.save(new AppPrivilege(null, "CRT-FAC", "Enregistrer affaires facultative", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege updFac = prvRepo.save(new AppPrivilege(null, "UPD-FAC", "Modifier affaires facultative", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege getFacDet = prvRepo.save(new AppPrivilege(null, "GET-FAC-DET", "Consulter détail affaire", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege sendFac = prvRepo.save(new AppPrivilege(null, "SEND-FAC", "Transmettre une affaires facultative", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege crtPlaFac = prvRepo.save(new AppPrivilege(null, "CRT-PLA-FAC", "Enregistrer un placement sur une affaires facultative", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege valFac = prvRepo.save(new AppPrivilege(null, "VAL-FAC", "Valider une affaire facultative", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege retFac = prvRepo.save(new AppPrivilege(null, "RET-FAC", "Retourner une affaire facultative", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege archFac = prvRepo.save(new AppPrivilege(null, "ARCH-FAC", "Archiver une affaire facultative", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege getEtaComptFac = prvRepo.save(new AppPrivilege(null, "GET-ETA-COMPT-FAC", "Consulter la situation comptable d'une affaire facultative", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege markFacRea = prvRepo.save(new AppPrivilege(null, "MARK-FAC-REA", "Marquer une affaire facultative comme réalisée", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege markFacNonRea = prvRepo.save(new AppPrivilege(null, "MARK-FAC-NON-REA", "Marquer une affaire facultative comme non réalisée", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege addDocFac = prvRepo.save(new AppPrivilege(null, "ADD-DOC-FAC", "Joindre une pièce à une affaire facultative", typeRepo.findByUniqueCode("PRV-PRV-FAC")));
        AppPrivilege crtBank = prvRepo.save(new AppPrivilege(null, "CRT-BANK", "Enregistrer une banque", typeRepo.findByUniqueCode("PRV-PRV-PARAM")));
        AppPrivilege updBank = prvRepo.save(new AppPrivilege(null, "UPD-BANK", "Modifier une banque", typeRepo.findByUniqueCode("PRV-PRV-PARAM")));
        ...
        AppPrivilege editChq = prvRepo.save(new AppPrivilege(null, "EDIT-CHQ", "Éditer un chèque de reversement sur une affaire facultative", typeRepo.findByUniqueCode("PRV-FA")));
