...
public class AssLoader implements Loader
{
    ...
    public void load()
    {
        ...
        List<AppPrivilege> prvOpeSaisie = prvRepo.findByPrvCodes(Arrays.asList("GET-STAT-FAC","GET-FAC-LST","CRT-FAC","UPD-FAC","GET-FAC-DET","CRT-PLA-FAC","VAL-FAC","RET-FAC-CED","ARCH-FAC","MARK-FAC-REA","MARK-FAC-NON-REA","ADD-DOC-FAC","CRT-REP-FAC","TRANS-FAC-SOUS","GET-FAC-HISTO","GET-FAC-MSG-SOUS",
                                                                               "GET-STAT-SIN","GET-SIN-LST","GET-SIN-FAC-LST","GET-SIN-TRAI-LST","GET-STAT-SIN","CRT-SIN","UPD-SIN","DEL-SIN","TRANS-SIN","GET-SIN-LST","GET-SIN-FAC-LST","GET-SIN-TRAI-LST","GET-SIN-SAI-LST","GET-SIN-TRANS-LST","GET-SIN-AVAL-LST","GET-SIN-SOLD-LST","GET-SIN-SUIV-LST","GET-SIN-ARCH-LST","GET-SIN-REG-LST","GET-SIN-HISTO","GET-SIN-DET","GET-SIN-MSG-SOUS","TRANS-SIN"));
        prvOpeSaisie.forEach(prv->this.addPrvToRole(prv, roleOpeSaisie));


        //ROLES GLOBALS
        AppRole roleSous = roleRepo.findByRoleCode("ROL-SOUS");
        List<AppPrivilege> prvOpeSous = prvRepo.findByPrvCodes(Arrays.asList("GET-STAT-FAC","GET-FAC-LST","GET-STAT-SIN","GET-SIN-LST","GET-SIN-FAC-LST","GET-SIN-TRAI-LST","GET-STAT-SIN","GET-SIN-LST","GET-SIN-FAC-LST","GET-SIN-TRAI-LST","GET-SIN-TRANS-LST","GET-SIN-AVAL-LST","GET-SIN-SOLD-LST","GET-SIN-SUIV-LST","GET-SIN-ARCH-LST","GET-SIN-REG-LST","GET-SIN-HISTO","GET-SIN-DET","TRANS-SIN-VAL","GET-SIN-MSG-VAL","RET-SIN-CED"));
        prvOpeSous.forEach(prv->this.addPrvToRole(prv, roleSous));

        AppRole roleValidateur = roleRepo.findByRoleCode("ROL-VAL");
        List<AppPrivilege> prvValidateur = prvRepo.findByPrvCodes(Arrays.asList("GET-STAT-FAC","GET-FAC-LST","GET-FAC-ARCH","GET-FAC-HIST","VAL-FAC","VAL-PLA","GET-STAT-SIN","GET-SIN-LST","GET-SIN-FAC-LST","GET-SIN-TRAI-LST","GET-STAT-SIN","GET-SIN-AVAL-LST","GET-SIN-SOLD-LST","GET-SIN-SUIV-LST","GET-SIN-ARCH-LST","VAL-SIN","TRANS-SIN-COMPTA","RET-SIN-SOUS","GET-SIN-HISTO","GET-SIN-DET","GET-SIN-REG-LST","GET-SIN-MSG-COMPTA"));
        prvValidateur.forEach(prv->this.addPrvToRole(prv, roleValidateur));

        AppRole roleComptable = roleRepo.findByRoleCode("ROL-COMPTA");
        List<AppPrivilege> prvComptable = prvRepo.findByPrvCodes(Arrays.asList("GET-STAT-FAC","GET-FAC-C-REG","GET-FAC-DET","GET-ETA-COMPT-FAC","CRT-REV-FAC","GET-REG-FAC-LST","GET-PAI-FAC-LST","GET-REV-FAC-LST","GET-STAT-SIN","GET-SIN-SOLD-LST-COMPTA","GET-SIN-SUIV-LST-COMPTA","GET-SIN-ARCH-LST-COMPTA","GET-REG-SIN-LST","CRT-PAI-SIN","CRT-REV-SIN","UPD-REV-SIN","GET-ETA-COMPT-SIN","TRANS-SIN","RET-SIN-VAL","GET-SIN-MSG-COMPTA"));
        ...
        List<AppPrivilege> prvOpeSaisieSin = prvRepo.findByPrvCodes(Arrays.asList("GET-STAT-SIN","CRT-SIN","UPD-SIN","DEL-SIN","TRANS-SIN","GET-SIN-LST","GET-SIN-FAC-LST","GET-SIN-TRAI-LST","GET-SIN-SAI-LST","GET-SIN-TRANS-LST","GET-SIN-AVAL-LST","GET-SIN-SOLD-LST","GET-SIN-SUIV-LST","GET-SIN-ARCH-LST","GET-SIN-REG-LST","GET-SIN-HISTO","GET-SIN-DET","GET-SIN-MSG-SOUS","TRANS-SIN-VAL","GET-SIN-MSG-VAL","RET-SIN-CED","GET-SIN-MSG-VAL","RET-SIN-SOUS","RET-SIN-SOUS"));
        ...
        List<AppPrivilege> prvValidateurFac = prvRepo.findByPrvCodes(Arrays.asList("GET-STAT-FAC","GET-FAC-LST","GET-FAC-C-REG","GET-FAC-ARCH","GET-FAC-HIST","VAL-FAC","VAL-PLA","GET-SIN-REG-LST","GET-SIN-HISTO","GET-SIN-DET"));
...
//        prvOpeSaisieSinistres.forEach(prv->this.addPrvToRole(prv, roleOpeSaisieSinistres));
        ...
        List<AppPrivilege> prvValidateurSin = prvRepo.findByPrvCodes(Arrays.asList("GET-STAT-SIN","GET-SIN-AVAL-LST","GET-SIN-SOLD-LST","GET-SIN-SUIV-LST","GET-SIN-ARCH-LST","TRANS-SIN-COMPTA","RET-SIN-SOUS","GET-SIN-HISTO","GET-SIN-DET","GET-SIN-REG-LST","GET-SIN-MSG-COMPTA"));
        ...
        List<AppPrivilege> prvComptableSin = prvRepo.findByPrvCodes(Arrays.asList("GET-STAT-SIN","GET-SIN-SOLD-LST-COMPTA","GET-SIN-SUIV-LST-COMPTA","GET-SIN-ARCH-LST-COMPTA","GET-REG-SIN-LST","CRT-PAI-SIN","CRT-REV-SIN","UPD-REV-SIN","GET-ETA-COMPT-SIN","RET-SIN-VAL","GET-SIN-MSG-COMPTA"));
